...
Built as a learning project — every layer is written by hand with explicit loops so you can see exactly what is happening at each step.
...
> **Note:** weights are randomly initialised — no training is implemented. The demo validates the pipeline shape, not accuracy.
